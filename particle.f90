...
module particle
    ...
    type properties 
        ...
        real(dp),public :: gradcoff(3),cdiff=0.0_dp,lamp=1.0_dp,gradvx=0.0_dp,tden=0.0_dp,vel=0.0_dp,&
                            S=0.0_dp,nut=0.0_dp,tke=0.0_dp,porosity=1.0_dp,resistx=0.0_dp,varts=0.0_dp, &
                            resisty=0.0_dp,pshift=0.0_dp,Kstar=0.0_dp,transporx=0.0_dp,transpory=0.0_dp
