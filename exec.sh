...
memory.f90 isph.f90 integrator.f90 turbulence.f90 part_shift.f90 qsort.f90 \
...
# scalar.f90 porous.f90 qsort.f90
...
-m64 ${MKLROOT}/lib/intel64/libmkl_blas95_lp64.a -L${MKLROOT}/lib/intel64 -Wl,--no-as-needed -lmkl_gf_lp64 -lmkl_intel_thread \
...
search.o gradient.o setup.o solver.o boundary.o output.o internal.o qsort.o \
...
# memory.o isph.o integrator.o turbulence.o part_shift.o \
# scalar.o porous.o qsort.o main.f90 -o main -lm -ldl
