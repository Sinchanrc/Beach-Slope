...
real(dp),public :: wc=0.650_dp,L=3.10_dp ,H=1.0_dp,&
                    ...
                    wl=3.10_dp,rho=1000.0_dp,g=-9.810_dp,tl=1e-3,Dm=2e-9,&
                    csh=0.50_dp,rx,ry,lid_driven=0.0010_dp,rhomin=1000.0_dp, &
                    rhomax,atwood=0.25870_dp,tschmidt=1.0_dp
...
real(dp),public :: r=0.0_dp,term1=0.0_dp,term2=0.0_dp,cs=0.150_dp,cv=0.080_dp,lamp,maxdivr=2.0_dp, &
                        ce=1.0_dp,dl,lamfs=0.80_dp,umax=0.0_dp,ker=0.0_dp,normx,normy,co,t_gam=7, &
                        pll=1.60_dp,pul=1.80_dp,hfac=4.80_dp,fac2=0.80_dp,numax=0.0_dp
