...
real(dp),public :: wc=0.650_dp,L=3.11_dp ,H=0.80_dp,&
                    ...
                    lhs_btm=0.23_dp,rel_den=1.020_dp

! dt=time step,t=simulation time
real(dp),public :: dt=0.001,t=0.0_dp,told=0.0_dp,time=7.60_dp,displaytime=0.050_dp,dtsol=0.010_dp, &
                    ins_1=0.0_dp,ins_2=0.0_dp !0.00001
